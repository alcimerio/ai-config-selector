...
// MaximumAuthJSONSize bounds the credential document accepted from a private
// projection. It is deliberately lower-layer policy, not a CLI concern.
const MaximumAuthJSONSize = maximumAuthJSONSize
