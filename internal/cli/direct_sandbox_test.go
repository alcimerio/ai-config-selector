...
//go:linkname newAdapterWithSandbox github.com/alcimerio/ai-config-selector/internal/adapter/devin.newAdapter
func newAdapterWithSandbox(devin.Config, launch.ProcessSandbox) (*devin.Adapter, error)
