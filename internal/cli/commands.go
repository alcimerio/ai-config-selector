...
var commands = []commandSpec{
	...
	{path: "profile history", syntax: "acs profile history [NAME | --lineage ID] [--limit N] [--json]", description: "Passively list bounded sanitized local Profile history. An unadopted Profile has empty history.", example: "acs profile history backend-review --json"},
	{path: "profile history pin", syntax: "acs profile history pin --lineage ID --revision EVENT [--json]", description: "Protect one immutable history event from retention pruning.", example: "acs profile history pin --lineage ln_0123456789abcdef0123456789abcdef --revision ev_0123456789abcdef0123456789abcdef"},
	{path: "profile history unpin", syntax: "acs profile history unpin --lineage ID --revision EVENT --confirm EVENT [--json]", description: "Remove explicit retention protection after exact event confirmation.", example: "acs profile history unpin --lineage ln_0123456789abcdef0123456789abcdef --revision ev_0123456789abcdef0123456789abcdef --confirm ev_0123456789abcdef0123456789abcdef"},
	{path: "profile history prune", syntax: "acs profile history prune --lineage ID [--keep N] --dry-run [--json]\n       acs profile history prune --lineage ID [--keep N] --expect DIGEST --confirm ID [--json]", description: "Preview or apply an exact digest-bound bounded history prune.", example: "acs profile history prune --lineage ln_0123456789abcdef0123456789abcdef --keep 50 --dry-run"},
