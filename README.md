...
The v0.3.3 support contract defines these Supported Platforms:
...
architecture pairs are not supported by v0.3.3.
...
```sh
archive=acs_0.3.3_darwin_arm64.tar.gz
...
### Evidence map for v0.3.3 protections
...
evidence for a broader production policy; macOS v0.3.3 claims are limited to
...
v0.3.3 preserves the v0.1.0 Profile envelopes, category schemas, public
...
- v0.3.3 macOS binaries are unsigned and unnotarized. Gatekeeper may block or
