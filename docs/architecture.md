...
operating-system family and version: macOS 26 or Ubuntu 24.04 LTS for v0.3.2. A
...
v0.3.2 macOS binaries are unsigned and unnotarized. Gatekeeper behavior can
...
It does not describe a broader production policy: v0.3.2 macOS claims remain
